<div class="box box-info">
    ...
    <!-- form start -->
    <?php echo $this->Form->create(null, ['class' => 'form-horizontal', 'id' => 'add_project', 'name' => 'add_project']); ?>
      <div class="box-body">
    ...
    $(document).ready(function() {
        ...
        $("#start_date").datepicker({
          ...
          endDate: false
    	    ...
    	    $('#add_project').formValidation('revalidateField', 'start_date');
    	});;
        $("#end_date").datepicker({
            format: 'yyyy-mm-dd',
            autoclose: true,
        	...
        	someDate.setDate(someDate.getDate() - 1); 
      	    $('#start_date').datepicker('setEndDate', someDate);
      	  	$('#add_project').formValidation('revalidateField', 'end_date');
      	});
