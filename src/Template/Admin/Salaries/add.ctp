<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Add Resource Salary Level') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create(null, ['url' => ['controller' => 'salaries', 'action' => 'add'], 'class' => 'form-horizontal', 'id' => 'add_salary', 'name' => 'add_salary', 'data-toggle' => 'validator']); ?>
      <div class="box-body">
        <div class="form-group">
          <label class="col-sm-2 control-label" for="inputFirstName3">User</label>
          <div class="col-sm-8">
             <?php 
				echo $this->Form->select('user_id',$userswithoutsalary,[
						'class' => 'form-control',
						'tabindex' => '6',
						'label' => false,
						'empty' => '(choose one)',
