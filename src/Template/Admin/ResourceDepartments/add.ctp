<div class="box box-info">
    <div class="box-header with-border">
      <h3 class="box-title"><?= __('Add Resource Department') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create(null, ['url' => ['controller' => 'resource_departments', 'action' => 'add'], 'class' => 'form-horizontal', 'id' => 'add_resource_department', 'name' => 'add_resource_department', 'data-toggle' => 'validator']); ?>
      <div class="box-body">
  ...
  <script>
    $(document).ready(function() {
      $('#add_resource_department').formValidation({
        framework: 'bootstrap',
        icon: {
        ...
        fields: {
          ...
          document.add_resource_department.submit();
      });
  });
</script>
