<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Add Project Modules') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create(null, ['url' => ['controller' => 'project_modules', 'action' => 'add'], 'class' => 'form-horizontal', 'id' => 'add_project_modules', 'name' => 'add_project_modules']); ?>
      <div class="box-body">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#add_project_modules').formValidation({
        framework: 'bootstrap',
        icon: {
        ...
        fields: {
          ...
          document.add_project_modules.submit();
      });
  });
  </script>
