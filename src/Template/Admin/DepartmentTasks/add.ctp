<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Add Department Task') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create(null, ['url' => ['controller' => 'department_tasks', 'action' => 'add'], 'class' => 'form-horizontal', 'id' => 'add_department_tasks', 'name' => 'add_department_tasks']); ?>
      <div class="box-body">
  ...
  <script>
    ...
    $(document).ready(function() {
      $("[data-mask]").inputmask();
      $('#add_department_tasks').formValidation({
        framework: 'bootstrap',
        icon: {
        ...
        fields: {
          ...
          document.add_department_tasks.submit();
      });
  });
  </script>
