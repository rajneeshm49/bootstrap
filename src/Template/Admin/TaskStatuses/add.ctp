<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Add Task Status') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create(null, ['url' => ['controller' => 'task_statuses', 'action' => 'add'], 'class' => 'form-horizontal', 'id' => 'add_task_status', 'name' => 'add_task_status', 'data-toggle' => 'validator']); ?>
      <div class="box-body">
  ...
  <script>
    $(document).ready(function() {
      $("[data-mask]").inputmask();
      $('#add_task_status').formValidation({
        framework: 'bootstrap',
        icon: {
        ...
        fields: {
          ...
          document.add_task_status.submit();
      });
  });
  </script>
