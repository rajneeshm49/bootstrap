<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Edit Receipt') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create($receipt, ['class' => 'form-horizontal', 'id' => 'edit_receipts', 'name' => 'edit_receipts', 'data-toggle' => 'validator']); ?>
      <div class="box-body">
