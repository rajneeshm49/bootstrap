<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Edit Issue Type') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create($issue_type, ['url' => ['controller' => 'issue_types', 'action' => 'edit'], 'class' => 'form-horizontal', 'id' => 'edit_issue_type', 'name' => 'edit_issue_type', 'data-toggle' => 'validator']); ?>
      <div class="box-body">
...
<?= $this->Html->script('Admin/form-validation.js') ?>
  ...
  <script>
    $(document).ready(function() {
      $("[data-mask]").inputmask();
      $('#edit_issue_type').formValidation({
        framework: 'bootstrap',
        icon: {
        ...
        fields: {
          ...
          document.edit_issue_type.submit();
      });
  });
  </script>
