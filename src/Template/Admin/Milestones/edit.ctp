<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Edit Milestone') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create($milestone, ['class' => 'form-horizontal', 'id' => 'edit_milestone', 'name' => 'edit_milestone', 'data-toggle' => 'validator']); ?>
      <div class="box-body">
           ...
           <div class="input-group">
              ...
              <?php 
				  echo $this->Form->input('start_date', [
						...
						'label' => false,
						'tabindex' => '8',
				        'value' => date('Y-m-d', strtotime($milestone->start_date))
	        		]);
			  ?>
           </div>
          </div>
            ...
            <div class="input-group">
              ...
              <?php 
				  echo $this->Form->input('end_date', [
						...
						'label' => false,
						'tabindex' => '8',
				        'value' => (!empty($milestone->end_date))?date('Y-m-d', strtotime($milestone->end_date)):''
	        		]);
			  ?>
           </div>
          </div>
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label"><?= __('Invoice No.')?></label>
          <div class="col-sm-8">
            <?php 
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label"><?= __('Invoice Dt.')?></label>
          <div class="col-sm-8">
            <?php 
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label"><?= __('Receipt Dt.')?></label>
          <div class="col-sm-8">
            <?php 
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label"><?= __('Received Amt.')?></label>
          <div class="col-sm-8">
            <?php 
    ...
    $(document).ready(function() {
      ...
      $('#edit_milestone').formValidation({
        ...
        fields: {
          ...
          document.edit_milestone.submit();
      });
  });
  </script>
