<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Edit Project Phase') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create($project_phase, ['class' => 'form-horizontal', 'id' => 'edit_project_phases', 'name' => 'edit_project_phases', 'data-toggle' => 'validator']); ?>
      <div class="box-body">
  ...
  <script>
    ...
    $(document).ready(function() {
      $("[data-mask]").inputmask();
      $('#edit_project_phases').formValidation({
        framework: 'bootstrap',
        icon: {
        ...
        fields: {
          ...
          document.edit_project_phases.submit();
      });
  });
  </script>
