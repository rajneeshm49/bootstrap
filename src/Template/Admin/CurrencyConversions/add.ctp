<div class="box box-info">
    <div class="box-header with-border">
      	<h3 class="box-title"><?= __('Convert currency (Add)') ?></h3>
    ...
    <!-- form start -->
    <?php echo $this->Form->create($conversion, ['class' => 'form-horizontal', 'id' => 'add_currency_conversion', 'name' => 'add_currency_conversion']); ?>
      <div class="box-body">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#add_currency_conversion').formValidation({
        framework: 'bootstrap',
        icon: {
        ...
        fields: {
          ...
          document.add_currency_conversion.submit();
      });
